	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SourcesV1alpha1().JobSources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SourcesV1alpha1().JobSources(namespace).Watch(options)
			},
		},
		&sourcesv1alpha1.JobSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sourcesv1alpha1.JobSource{}, f.defaultInformer)
}
